...
//图书分类
$sql = "SELECT id, title FROM {$t_}sub WHERE cid=$MusicId ORDER BY id DESC";
...
<form class="layui-form" action="index.php?go=music_add_do" method="post" enctype="multipart/form-data">
    ...
    <div class="layui-form-item" style="display:flex;">
        <div>
            ...
            <div class="layui-input-block">
                <input type="text" name="singer" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div>
            <label class="layui-form-label">作曲</label>
            <div class="layui-input-block">
                <input type="text" name="compose" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="layui-input-block">
                <input type="text" name="writer" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" style="width:272px;" id="dt" name="dt" placeholder="请选择日期">
        </div>
    </div>
